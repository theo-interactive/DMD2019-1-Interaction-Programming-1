...
*/
//console.log(document.title); //6Week
document.title = '21861003_강주연';
console.log(document.title); //21861003_강주연
...
//console.log(title); 오류가 생기는 군요.......

/*
Quest 3.
1. class 가 'title' 인 요소에 '안녕하세요.' 문자열이 포함되도록 작성합니다.
*/
var content = document.getElementsByClassName('title');
//console.log(title); 얘도 오류가 생기는 군요,,,,.,
