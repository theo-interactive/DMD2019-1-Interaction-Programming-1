...
var even1 = 'getEven(10)의 결과 : ' + getEven(10);
console.log(even1);
...
var star2 = getStar(5);
console.log('getStar("text")의 결과 : ' + star1);
console.log('getStar(5)의 결과 : ' + star2);
...
var getSize = function()
{
    ...
    + " 윈도우 콘텐츠 영역의 넓이 값 , " + "winHeight : " + window.innerHeight + " 윈도우 콘텐츠 영역의 높이값"];
}
