...
// SCRIPT5007: SCRIPT5007: Unable to get property 'addEventListener' of undefined or null reference 라고 뜬다 왜???????????? 빠른 포기,, 모르겠다. 왜 안되는지
...
var bt_chk = document.getElementById("btn-check-id");
var U_id = document.getElementById("user_id");
//var idlen = $id.value.length;
bt_chk.addEventListener('click',function(event){
    var leng = U_id.value.length;
    console.log("input#user_id - value 속성 값의 개수는"+  leng +"입니다.");
})
//Unable to get property 'addEventListener' of undefined or null reference 이거 대체 .....????? 이게 왜이러는거죠???? 
