...
$btn2.addEventListener('click', function(event){
    var value = $id.value.length;
    console.log("input#user_id - value 속성값의 개수는 " + value + "입니다.");
});
//식은맞는거같은데 왜 안돼는지 모르겟습니다.
...
var $user_id = user_id.getElementById("user_id");
var $user_pass = user_pass.getElementById("user_pass")


    $btn5.addEventListener('click', function(event){
    var reset = prompt("초기화하시려면 100을 입력하세요");
    var user_id = $id.value.length;
