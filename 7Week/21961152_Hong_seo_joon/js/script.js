...
*/
var buttonbtn_window_size = document.getElementById('button size');
buttonbtn_window_size.addEventListener('click', function(event){
console.log('문자열 결과'+'윈도우 콘텐츠의 영역'+ 'width : ____ px,' + 'height : ____ px' + '입니다.');
}
...
button_cancel.addEventListener('click', function(event){location.reload();});
...
var button_apply = document.getElementById("button-apply");
var ch = confirm("가입하시겠습니까?"); 
if(ch === true){ 
    alert("가입을 환영합니다!"); 
} 
