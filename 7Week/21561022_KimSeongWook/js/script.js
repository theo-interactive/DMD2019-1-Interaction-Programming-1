...
var _btn = document.getElementById("btn-window-size");
btn.addEventListener("click", function(event){
alert("윈도우 콘텐츠의 영역 width : " + _Width + "px, height : " + _Height + " px 입니다." );})
...
*/
var _btn2 = document.getElementById("btn-check-id");
var id = document.getElementById("user_id");
btn2.addEventListener("click,",function(event){
    console.log("input#user_id - value 속성 값의 개수는 " + id + "입니다.");
})
...
/*
var but_re = document.getElementById("btn-reset");
but_re.addEventListener("click",function(event){
    var pro = prompt.("초기화 하려면 100을 입력 하세요.");})
*/
...
/*
    ...
    btn_color = document.addEventListener("click",function(event) {
