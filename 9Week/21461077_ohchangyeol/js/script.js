...
var $btn1 = document.querySelector('button#btn-student-number');
// console.log($btn1);
$btn1.addEventListener("click", myNumber);
function myNumber (){
    var _myNumber = document.getElementById("student-number");
    _myNumber.innerText = "21461077";
    alert("학번이 입력되었습니다.")
};
    
var $btn2 = document.querySelector("button#btn-student-name");
$btn2.addEventListener("click", Name);
function Name (){
    var _myName = document.getElementById("student-name");
    _myName.innerText = "오창열";
    alert("이름이 입력되었습니다.")
};
...
// 2) 사용자가 입력한 수를 기준으로 0부터 해당 숫자까지의 숫자 중 홀수인 숫자를 아래 보기와 같이 
//    문자열 연산하여 결과를 div#odd-result 의 내부에 입력될 수 있도록 작성합니다.
...
var $btn3 = document.querySelector("button#btn-odd");
...
var $btn4 = document.querySelector("button#btn-add-item");
$btn4.addEventListener("click", oooo);
function oooo(event){
    var aa = prompt("숫자를 입력하세요");
...
// 3) button#btn-color-2 를 클릭한 경우, 'box' 라는 클래스 이름을 가진 div 요소 중 3번째 
//    요소의 배경색 스타일을 'blue', 글자색 스타일을 'black' 으로 변경합니다.

// > 배점 : 4점 (부분배점 - 1 : 2점, 2 : 2점)

var $btn5 = document.querySelector("button#btn-color-1");
var $btn6 = document.querySelector("button#btn-color-2");
// console.log($btn5); 
var $box = document.getElementsByClassName ("box");
$btn5.addEventListener("click", onebtn1);
function onebtn1(event){
    // console.log($box);
...
$btn6.addEventListener("click", onebtn2);
function onebtn2(event){
    // console.log($box);
...
var $btn7 = document.querySelector(" button#btn-star");
// console.log($btn7);
$btn7.addEventListener("click", star);
function star(event){
    var aa = prompt("숫자를 입력하세요");
    var room = document.getElementById("star-result");
    for(var i = 0 ; i < aa; i++){
        for(var j = 0 ; j < aa; j++){
            if (j > i) {
                room.innerText+="☆";
