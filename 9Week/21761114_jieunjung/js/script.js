...
var $btnSN = document.querySelector("button#btn-student-number");
$btnSN.addEventListener("click", onClickBtnSN);
function onClickBtnSN(event){
    event.preventDefault();
    var isCheck = prompt("학번");
    if(isCheck)
    {
        alert("학번이 입력되었습니다.");
    }
...
function onClickBtnOdd(event){
    ...
    var n = "";
        for(var i = 0; i < n; i++){
            $listItem4.setAttribute("div#odd-result",n);
        }
}
